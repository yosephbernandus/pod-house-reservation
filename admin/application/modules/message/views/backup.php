...
<style>
  ...
  #load {
    ...
    font-size   : 0;
    opacity     : 0.6;
    background  : #E0E0E0  url(<?php echo base_url('../assets/img/load.gif');?>) center no-repeat;
  }
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        <ul class="nav nav-pills pull-right" role="tablist">
          <li role="presentation"><a href="#">New messages <span class="badge new_count_message" id=""><?php echo $this->db->where('read_status',0)->count_all_results('message');?></span></a></li>
        </ul>
      </div>
