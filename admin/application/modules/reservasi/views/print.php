...
// $pdf->SetHeaderData('biz.png', PDF_HEADER_LOGO_WIDTH, PDF_HEADER_TITLE.' 006', PDF_HEADER_STRING);
$pdf->SetHeaderData("pod-house.jpg", PDF_HEADER_LOGO_WIDTH, 'Manado Pod House', "Jalan Temboan No.11, Winangun Dua Malalayang 95115\nSulawesi Utara, Indonesia\nPhone: +62-123-4567\nFacebook : @manadopodhouse");
...
$headings = '<br><h3>Reservation Detail</h3>';
$pdf->writeHTMLCell(0,0, '', '', $headings, 0 ,1 ,0, true, 'C', true);

$input_date = '<div style="text-align: right"><h4>Date : '.$arr_reservasi->input_date;'</h4></div>';
$pdf->writeHTMLCell(0,0, '', '', $input_date, 0 ,1 ,0, true, 'C', true);

// $from = '<table>
//             <tr>
//                 <td style="display: inline;">
//                     <div style="text-align: left; float:left">From
//                         <address>
//                             <strong>Biz Boulevard Hotel Manado</strong>
//                             <br>Jl. Piere Tendean No. 35, Manado 95111
//                             <br>Sulawesi Utara, Indonesia
//                             <br>Phone: +62-431-850585
//                             <br>Facebook : @bizboulevard
//                         </address>
//                     </div>
//                 </td>';

// $pdf->writeHTMLCell(0,0, '', '', $from, 0 ,1 ,0, true, 'C', true);


$to = '<div style="text-align: justify; float:right"> ';
$to.=       '<address>';
$to.=               '<br><strong>ID Reservasi :   '.$arr_reservasi->id_reservasi;;'</strong>';
$to.=               '<br>Name       :   '.$arr_reservasi->guest_name;'';
$to.=               '<br>Company    :   '.$arr_reservasi->company;'';
$to.=               '<br>Country    :   '.$arr_reservasi->country;'';
$to.=               '<br>province   :   '.$arr_reservasi->country;'';
$to.=               '<br>Phone      :   '.$arr_reservasi->telp;'';
$to.=               '<br>Email      :   '.$arr_reservasi->email;'';
$to.=       '</address>';
$to.= '</div>';
$pdf->writeHTMLCell(0,0, '', '', $to, 0 ,1 ,0, true, 'C', true);
// $to = '<div style="text-align: left; float:right">To ';
// $to.=       '<address>';
// $to.=           '<strong>'.$reservasi['guest_name'];'</strong>';
// $to.=               '<br>'.$reservasi['company'];'';
// $to.=               '<br>'.$reservasi['country'];'';
// $to.=               '<br>'.$reservasi['province'];'';
// $to.=               '<br>Phone :'.$reservasi['telp'];'';
// $to.=               '<br>Email :'.$reservasi['email'];'';
// $to.=       '</address>';
// $to.= '</div>';
// $pdf->writeHTMLCell(0,0, '', '', $to, 0 ,1 ,0, true, 'C', true);
...
$total = '<br><br><strong><div style="text-align: right">Total : Rp.'.number_format($total, 0, ".", ".").'</div></strong>';
$pdf->writeHTMLCell(0,0, '', '', $total, 0 ,1 ,0, true, 'C', true);
